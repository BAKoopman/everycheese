...
)  # (mysite/config/settings/base.py - 3 = mysite/)
APPS_DIR = BASE_DIR.path("mysite")
...
DATABASES = {
    ...
    "default": env.db(
        "DATABASE_URL", default="postgres:///mysite"
    )
}
...
ADMINS = [("""Bryce Koopman""", "brycek.3434@gmail.com")]
...
SOCIALACCOUNT_ADAPTER = (
    "mysite.users.adapters.SocialAccountAdapter"
)
